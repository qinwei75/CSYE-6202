...
{
    public partial class frmClinicHomePage : Form, IClinicHomePage
    {
        ...
        string LoginType;
        public frmClinicHomePage(string loginType)
        {
            InitializeComponent();
            LoginType = loginType;
            if (loginType == admin)
        ...
        {
            Dispose();
            ILoginPage view = new frmLoginPage();
        ...
        private void LoadInformation()
        {
            ...
            con.ConnectionString = dbconfig.StringBuilder();
            con.Open();
            appointmentTable = appDAL.getAppointmentsTable(con);
        ...
        {
            Dispose();
            IView view = new frmMakeAppointment(LoginType);
            IModel model = new Model();
            var present = new Presenter(model, view);
        ...
        private void btnCancelAppointment_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("Are you sure you want to remove this Appointment?", "Remove Appointment Confirmation", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
